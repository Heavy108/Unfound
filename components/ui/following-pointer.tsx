    ...
    >
      {showIcon && ( // ✅ conditional render
        <svg
          ...
          strokeWidth="1"
          viewBox="0 0 16 16"
          className="h-6 w-6 -translate-x-[2px] -translate-y-[2px] -rotate-[90deg] transform stroke-[#37B779] text-[#37B779]"
          height="1.6rem"
          width="1.3rem"
      ...
      {title ? (
        <motion.div
          ...
          className="bg-[#37B779] w-[2.8rem]  px-[0.62rem] py-[0.25rem] ml-5 -mt-1.25 rounded-[0.32rem]" // 🔹 keep blank, you can design this separately
        >
          <span className="flex justify-center items-center text-white font-satoshimedium">
            {title}
          </span>
        </motion.div>
      ) : (
